 ...
 */
public class CustomRepainter extends RepaintManager {
	...
	public CustomRepainter(boolean completeCheck) {
		this.completeCheck = completeCheck;
	}
	
	public CustomRepainter() {
		this(true);
	}
	...
	protected void violationFound(JComponent c, StackTraceElement[] stackTrace) {
		System.out.println();
		Logger.log(Logger.DEBUG, "EDT violation detected");
		Logger.log(Logger.DEBUG, "" + c);
		for (StackTraceElement st : stackTrace) {
			Logger.log(Logger.DEBUG, "\tat " + st);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		Logger.log(Logger.DEBUG, "Valid code passed...");
		repaintTest();
		Logger.log(Logger.DEBUG, "Repaint test - correct code");
